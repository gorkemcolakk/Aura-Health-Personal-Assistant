class TranslationService {
  static const Map<String, Map<String, String>> _translations = {
    ...
    'prof_blood': {'tr': 'Kan Grubu (örn: A Rh+)', 'en': 'Blood Type (e.g. A Rh+)'},
    'prof_allergies': {'tr': 'Alerjiler (örn: Penisilin, Fıstık)', 'en': 'Allergies (e.g. Penicillin, Peanuts)'},
    ...
    'pdf_health_data': {'tr': 'SAĞLIK VERİLERİ (Son 7 Gün)', 'en': 'HEALTH DATA (Last 7 Days)'},
